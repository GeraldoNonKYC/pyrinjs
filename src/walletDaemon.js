...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/pyrinwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { pyrinwalletd } = gRPC.loadPackageDefinition(packageDefinition).pyrinwalletd

    this._client = new pyrinwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
